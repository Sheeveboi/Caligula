-- DROP FUNCTION public.remove_alert_channel();

CREATE OR REPLACE FUNCTION public.remove_alert_channel(id int)
	RETURNS int
	LANGUAGE plpgsql
AS $$
...
BEGIN
	...
	DELETE FROM alert_channels WHERE channel_id = id;
